...
async def test_tv_pack_queries_keep_exact_manual_season_query_first() -> None:
    ...
    require(queries[0] == "The Boys S01", "season pack search should start with the literal manual season query")
    require("The Boys" in queries, "broad title form should still be included for recall")
...
async def main() -> None:
    ...
    await test_tv_pack_queries_keep_exact_manual_season_query_first()
