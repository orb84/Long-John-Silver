...
class IntentRouter:
    ...
    _ROUTING_PROMPT = (
        ...
        "- DOWNLOAD means the user wants to find/queue/control downloads or act on pending torrent candidates.\n"
        ...
        "- SEARCH means the user wants information/research/metadata without queueing anything.\n"
        ...
        "- CONFIG means the user wants settings, providers, categories, scheduled reminders, recurring checks, or app configuration changed/discussed.\n"
